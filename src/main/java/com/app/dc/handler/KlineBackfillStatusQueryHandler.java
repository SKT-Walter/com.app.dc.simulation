...
@Slf4j
@Service("dc.sim.kline.backfill.status.query")
public class KlineBackfillStatusQueryHandler extends ContentHandler {
    ...
    public Map<String, Object> handle(String topic, Message message, String content, Map<String, Object> map,
        ...
        try {
            ...
            Map<String, Object> data = manualKlineBackfillService.query(
                    text(request, "jobId"),
            ...
            log.error("KlineBackfillStatusQueryHandler error, topic:{}, content:{}", topic, content, e);

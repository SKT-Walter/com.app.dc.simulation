...
public class BacktestMetricService {
    ...
    public void applyTrade(StrategyRunResult result, TradeRecord tradeRecord, EquityContext context) {
    ...
    public void finishResult(StrategyRunResult result, EquityContext context) {

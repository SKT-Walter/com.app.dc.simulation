...
@Service("rsiKdjReversionETH")
public class RsiKdjReversionETH extends RsiKdjReversionBacktestStrategy {
    @Override public String getName() { return "rsiKdjReversionETH"; }
}

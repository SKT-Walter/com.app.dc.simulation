...
@Service("ethStructuralBullTrendETH")
public class EthStructuralBullTrendETH extends EthStructuralBullTrendBacktestStrategy {
    @Override public String getName() { return "ethStructuralBullTrendETH"; }
}

...
@Service("atrChannelBiasReversionSOL")
public class AtrChannelBiasReversionSOL extends AtrChannelBiasReversionBacktestStrategy {
    @Override public String getName() { return "atrChannelBiasReversionSOL"; }
}

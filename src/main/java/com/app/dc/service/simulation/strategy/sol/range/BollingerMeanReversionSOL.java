...
@Service("bollingerMeanReversionSOL")
public class BollingerMeanReversionSOL extends BollingerMeanReversionBacktestStrategy {
    @Override public String getName() { return "bollingerMeanReversionSOL"; }
}

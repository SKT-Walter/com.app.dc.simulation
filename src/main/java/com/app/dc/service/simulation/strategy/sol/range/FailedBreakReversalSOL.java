...
@Service("failedBreakReversalSOL")
public class FailedBreakReversalSOL extends FailedBreakReversalBacktestStrategy {
    @Override public String getName() { return "failedBreakReversalSOL"; }
}
